...
namespace TravelApp.Data.Migrations
{
    ...
    [Migration("20221204140741_AddedTownJourneyMappingClass")]
    partial class AddedTownJourneyMappingClass
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelApp.Data.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0650610d-d23f-4f0a-bc74-792d4d795c44",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJRPWGe919TMH6mRU9ElsvdTh08EntKTRjyPlaRtgwYX8+BSZiFHCGJJFJKQ0bsqAA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "4f576dab-680a-4613-b1b2-01514fa93480",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "567df97a-f1e9-4a0a-b215-be9124200eb4",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEEL02YZ8uLgiTmxTS7+P9r62ZH4qEt9S4o8uxhxJAbc+Kzjq6ioTl2Dwev0MOEgStw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "a0d0d875-5a65-4fff-8e17-8ed5f6d6750d",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "424d7310-be5f-46b8-94c2-0810e1a61980",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBxDeM+FJfgTEB3Np2uB4dv701FEezmlTkUkmKFgGH+/sfG04/UWbjgnegSol/E2VA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "ba8bee92-83df-472d-88b6-d8502dbce3fc",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("TravelApp.Data.Entities.TownJourney", b =>
                {
                    b.Property<int>("JourneyId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("JourneyId", "TownId");

                    b.HasIndex("TownId");

                    b.ToTable("TownsJourneys");
            ...
            modelBuilder.Entity("TravelApp.Data.Entities.TownJourney", b =>
                {
                    b.HasOne("TravelApp.Data.Entities.Journey", "Journey")
                        .WithMany("TownsJourneys")
                        .HasForeignKey("JourneyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TravelApp.Data.Entities.Town", "Town")
                        .WithMany()
